      ...
      .then((response) => {
        ...
        if (isAfter(currentDate, firstDayOfWeekParese)) {
          ...
          bookingOfWeek = bookingList.reduce((acc, booking) => {
            ...
            console.log("timeRentalParse: ",isAfter(lastDayOfWeekParese, timeRentalParse))
          ...
          bookingOfWeek = bookingList.reduce((acc, booking) => {
            ...
            if ((isBefore(firstDayOfWeekParese, timeRentalParse) && isAfter(lastDayOfWeekParese, timeRentalParse)) || isSameDay(firstDayOfWeekParese, timeRentalParse) || isSameDay(lastDayOfWeekParese, timeRentalParse)) {
              // console.log("booking.time_rental: ",booking.time_rental)
              acc.push(booking.time_rental);
            }
        ...
        // console.log("bookingOfWeek:", bookingOfWeek);
        ...
        const busyHours = Object.keys(weekDays).reduce((acc, key) => {
          ...
          if (bookingOfWeek.length > 0) {
            ...
            bookingOfWeek.forEach((timeRental) => {
              ...
              console.log("dayParese", dayParese)
              console.log("isSameDay(timeRentalParse, dayParese)", isSameDay(timeRentalParse, dayParese))
              console.log("isAfter(currentDate, dayParese)", isAfter(currentDate, dayParese))
              // && timeRentalParse.getHours() >= getHours(currentDate)
              if (isSameDay(timeRentalParse, dayParese) && isBefore(currentDate, dayParese)) {
                console.log("timeRentalParse", timeRentalParse)
