                ...
                <div class="row">
                    <div class="col-md-6 col-12">
                        ...
                        <div class="favorite-container">
                            ...
                            <form action="favor" method="post" id="favoriteForm">
                                <input type="hidden" name="productID" value="${product.productId}">
                                <button type="button" style="background: none; border: none; padding: 0; position: relative;" id="favoriteButton">

                                    <i class="fas fa-heart text-primary" style="font-size: 18px;"></i>
                                </button>
                                <p id="favoriteText">Thêm yêu thích</p>
                            </form>
                        </div>
                        ...
                        <div class="Scriptcontent">
                            ...
                            <div class="feedback">
                                ...
                                <form method="post" action="reviewproduct">
                                    ...
                                    <br>
                                    <div class="clear"></div> 
                                    <button style="background:#43a7d5;color:#fff;padding:12px;border:0" type="submit" value="" onclick="validateForm()">Xác nhận </button>&nbsp;
                                    ...
                                    <th>
                                        <div class="review-order dropdown" id="review-sort">
                                            ...
                                            <ul class="dropdown-menu sort-drop" aria-labelledby="sortMenu">
                                                <li class="sort-option special" data-sort="2"  onclick="viewProduct('${product.productId}')">Đánh giá: cao - thấp</li>
                                ...
                                <c:forEach var="r" items="${listrv}">
                                    ...
                                    <span class="star-rating">
                                        <c:forEach var="i" begin="1" end="5">
                                            <input type="radio" name="rating1" <c:if test="${i <= r.rate}">checked</c:if>><i></i>
                                        </c:forEach>
                                    </span>
                                    <div>${r.comment}</div>
                                </c:forEach>
              ...
              function viewProduct(id) {
               ...
               $(document).ready(function () {
                $("#favoriteButton").click(function () {
                    // Toggle the 'text-danger' class on button click
                    $(this).find("i").toggleClass("text-danger");
                    var buttonText = $("#favoriteText");    
                    // Submit the form when the heart icon is clicked
                    $("#favoriteForm").submit();
                });
            });
        </script>
