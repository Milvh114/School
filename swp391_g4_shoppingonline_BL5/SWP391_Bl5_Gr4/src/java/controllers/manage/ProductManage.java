...
public class ProductManage extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (user != null && user.getRole().getRoleId() == 4) {
            ...
            List<Product> listP = dao.listProduct(page, LAST_PAGE);
            ...
            ArrayList<Category> lscate = cate.getAllCategory();
            request.setAttribute("listCategory", lscate);
                request.setAttribute("page", page);
                 request.setAttribute("totalPage", totalPage);
            request.setAttribute("listP", listP);
            request.getRequestDispatcher("views/Manage/ProductManagement.jsp").forward(request, response);
