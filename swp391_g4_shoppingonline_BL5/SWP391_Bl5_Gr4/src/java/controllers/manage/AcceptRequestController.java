 ...
 * @author dell
 */
@WebServlet(name = "AcceptRequestController", urlPatterns = {"/AcceptRequest"})
...
//        if (user != null && user.getRole().getRoleId() == 6) {
            ...
            int orderId = Integer.parseInt(request.getParameter("orderIdAccept"));
            oDao.updateOrderStatus(1, orderId);       
          RequestDispatcher dispatcher = request.getRequestDispatcher("/OrderRequest");
