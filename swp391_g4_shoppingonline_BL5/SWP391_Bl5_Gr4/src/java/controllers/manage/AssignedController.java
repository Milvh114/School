 ...
 * @author dell
 */
@WebServlet(name = "AssignedController", urlPatterns = {"/Assigned"})
public class AssignedController extends HttpServlet {
    /** 
    ...
    @Override
     ...
     HttpSession session = request.getSession();
        ...
        if (user != null && user.getRole().getRoleId() == 5) {
            ...
            int saleStaff = Integer.parseInt(request.getParameter("saleUser"));
            
            oDao.updateSaleUser(orderId, saleStaff);       
